 ...
 *   4. doStep 调用用户模型的 step 回调
 *
 * 本文件由用户编写或从模板生成，编译为共享库的一部分。
 */
...
fmi2Status fmi2SetupExperiment(fmi2Component c, fmi2Boolean toleranceDefined,
    ...
    if (inst->state != STATE_INSTANTIATED) {
        log_msg(inst, fmi2Error, "logStatusError",
                "fmi2SetupExperiment: 状态错误，需在 instantiated 状态调用");
        return fmi2Error;
    }
    ...
    log_msg(inst, fmi2OK, "logStatusOK", "fmi2SetupExperiment: 完成");
    return fmi2OK;
}
...
fmi2Status fmi2EnterInitializationMode(fmi2Component c) {
    ...
    if (inst->state != STATE_INSTANTIATED) {
        log_msg(inst, fmi2Error, "logStatusError",
                "fmi2EnterInitializationMode: 状态错误");
        return fmi2Error;
    }

    inst->state = STATE_INIT_MODE;
    log_msg(inst, fmi2OK, "logStatusOK",
            "fmi2EnterInitializationMode: 进入初始化模式");
    return fmi2OK;
}
...
fmi2Status fmi2ExitInitializationMode(fmi2Component c) {
    ModelInstance* inst = (ModelInstance*)c;
    if (!inst) return fmi2Error;
    if (inst->state != STATE_INIT_MODE) {
        log_msg(inst, fmi2Error, "logStatusError",
                "fmi2ExitInitializationMode: 状态错误，需在 initMode 状态调用");
        return fmi2Error;
    }

    inst->state = STATE_STEP_MODE;
    log_msg(inst, fmi2OK, "logStatusOK",
            "fmi2ExitInitializationMode: 退出初始化模式，进入步进模式");
    return fmi2OK;
}
...
fmi2Status fmi2Terminate(fmi2Component c) {
    ...
    log_msg(inst, fmi2OK, "logStatusOK", "fmi2Terminate: FMU 已终止");
    return fmi2OK;
}
...
fmi2Status fmi2Reset(fmi2Component c) {
    ...
    log_msg(inst, fmi2OK, "logStatusOK", "fmi2Reset: FMU 已重置");
    return fmi2OK;
}
...
fmi2Status fmi2GetReal(fmi2Component c, const fmi2ValueReference vr[],
    ...
    rc_lowpass_route_getReal(&inst->model, vr, nvr, value);
    return fmi2OK;
}
...
fmi2Status fmi2SetReal(fmi2Component c, const fmi2ValueReference vr[],
    ...
    rc_lowpass_route_setReal(&inst->model, vr, nvr, value);
    return fmi2OK;
}
...
fmi2Status fmi2SetRealInputDerivatives(fmi2Component c,
    ...
    ModelInstance* inst = (ModelInstance*)c;
    (void)vr; (void)nvr; (void)order; (void)value;
    log_msg(inst, fmi2Error, "logStatusError",
            "fmi2SetRealInputDerivatives: 未实现");
    return fmi2Error;
}
...
fmi2Status fmi2GetRealOutputDerivatives(fmi2Component c,
    ...
    (void)vr; (void)nvr; (void)order; (void)value;
    log_msg(inst, fmi2Error, "logStatusError",
            "fmi2GetRealOutputDerivatives: 未实现");
    return fmi2Error;
}
...
fmi2Status fmi2DoStep(fmi2Component c,
    ...
    /* 调用用户模型单步推进 */
    int ret = rc_step(&inst->model, currentCommunicationPoint, communicationStepSize);
    if (ret != 0) {
        log_msg(inst, fmi2Error, "logStatusError",
...
fmi2Status fmi2CancelStep(fmi2Component c) {
    ModelInstance* inst = (ModelInstance*)c;
    if (!inst) return fmi2Error;
    log_msg(inst, fmi2OK, "logStatusOK", "fmi2CancelStep: 步进已取消");
    return fmi2OK;
}
